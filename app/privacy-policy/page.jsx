  ...
  return (
    <ContentLayout>
      <section className={block}>
        <h1 className={header}>
          Privacy Policy <br/> of the Embodied Learning Institute
        </h1>

        <p className={content}>
          Embodied Learning Institute operates the
          https://www.embodiedlearninginstitute.com/ website, which provides the
          service of email newsletter registration, and appointment scheduling.
        </p>

        <p className={content}>
          This page is used to inform website visitors regarding our policies
          with the collection, use, and disclosure of Personal Information if
          anyone decided to use our Service, the Embodied Learning Institute
          website.
        </p>
        ...
        <p className={content}>
          ...
          https://www.embodiedlearninginstitute.com/, unless otherwise defined
          in this Privacy Policy.
        </p>
      </section>

      <section className={block}>
        <h2 className={subheader}>Information Collection and Use</h2>
      ...
      <section className={block}>
        <h2 className={subheader}>Log Data</h2>
      ...
      <section className={block}>
        <h2 className={subheader}>Cookies</h2>
      ...
      <section className={block}>
        <h2 className={subheader}>Service Providers</h2>
      ...
      <section className={block}>
        <h2 className={subheader}>Security</h2>
      ...
      <section className={block}>
        <h2 className={subheader}>Links to Other Sites</h2>
      ...
      <section className={block}>
        <h2 className={subheader}>Changes to This Privacy Policy</h2>
