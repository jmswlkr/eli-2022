...
export const HeroSection = (props) => {
  return (
    <section className='HERO_SECTION isolate hero-container-1 bg-primary-300 relative w-full'>
      <HeroText />
      <HeroBG />
    </section>
  )
...
function HeroText() {
  return (
    <div className='HERO_TEXT max-w-4/5 full flex-col-center gap-lg relative z-10'>
      ...
      <Button text='Get Started' path="/#intro" classes='solid sm lg:med !bg-primary-300 !border-none'/>
    </div>
  )
}
